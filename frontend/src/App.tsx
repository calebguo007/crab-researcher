    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-2 mb-4">
          <a href={`${import.meta.env.VITE_OAUTH_BASE || 'https://crab-researcher.onrender.com/api'}/oauth/google`}
          ...
          <a href={`${import.meta.env.VITE_OAUTH_BASE || 'https://crab-researcher.onrender.com/api'}/oauth/github`}
            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg border border-border text-sm font-medium text-primary hover:bg-hover transition-colors">
